...
计算方法：
1. 使用 Mifflin-St Jeor 公式计算 BMR（假设中等活动水平，系数 1.55）
2. 根据目标调整：减脂 -300~500kcal，增肌 +200~300kcal，维持不变
3. 每周放纵餐会额外摄入热量，需在其余餐中适当减少以维持周均目标
4. 蛋白质：减脂 2g/kg，增肌 1.8g/kg，维持 1.5g/kg
5. 脂肪：总热量的 25-30%
6. 碳水：剩余热量
