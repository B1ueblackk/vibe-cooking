  ...
  return (
    <div className="pt-14 pb-24">
      ...
      <div className="px-5 mb-5 flex items-center gap-3">
        ...
        <h1 className="font-serif text-xl text-vc-brown-dark">收藏菜谱</h1>
      ...
      {loading ? (
        ...
        <div className="mx-5 bg-white rounded-3xl shadow-[var(--shadow-vc-sm)] p-8 text-center">
          <div className="text-4xl mb-3">
            <Heart className="mx-auto text-red-300" size={40} />
          </div>
          <p className="text-vc-brown-medium text-sm">还没有收藏菜谱</p>
          <p className="text-vc-brown-light text-xs mt-1">浏览社区或菜谱详情时点击收藏</p>
        </div>
      ) : (
