  ...
  return (
    <div className="pt-14 pb-24">
      ...
      <div className="px-5 mb-5 flex items-center gap-3">
        ...
        <Sparkles size={18} className="text-vc-amber" />
        <h1 className="font-serif text-xl text-vc-brown-dark">AI 生成记录</h1>
      ...
      {loading ? (
        ...
        <div className="mx-5 bg-white rounded-3xl shadow-[var(--shadow-vc-sm)] p-8 text-center">
          ...
          <p className="text-vc-brown-medium text-sm">还没有 AI 生成记录</p>
          <p className="text-vc-brown-light text-xs mt-1">在首页输入食材，AI 会自动保存生成的菜谱</p>
        </div>
      ) : (
          ...
          {recipes.map((recipe) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-vc-forest/15 to-vc-amber/15 flex items-center justify-center text-2xl shrink-0">
                  🍳
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  {recipe.sourceIngredients && recipe.sourceIngredients.length > 0 && (
                    <p className="text-[0.68rem] text-vc-brown-light mt-1.5">
                      食材：{recipe.sourceIngredients.join("、")}
                    </p>
                  )}
                </div>
              </div>
